...
overflow:auto;">
    ...
    <div class="card-body">
        ...
        <!-- form start -->
        <form id="validate" action="{{ route('pos.store') }}" method="post" >
            @csrf 
            ...
            <div class="row">
                ...
                <div class="col-6 mb-3 float-start">
                    <input type="text" required id="basic-datepicker" name="transaction_date" class="form-control flatpickr-input active" placeholder="Transaction date" required>
                </div>       
            </div>                   
            ...
            <table id="table" class="table table-responsive">
                ...
                <tbody id="TBody">
                    <tr id="TRow"> 
                        <td>
                            <input type="text" class="form-control fields" name="product_name[]" placeholder="Product name" required>
                        </td>

                        <td>
                            <input type="number" id="qty" onchange="Calc(this);" value="1" min="1" class="form-control fields" name="qty[]" placeholder="Qty" required>
                        </td>

                        <td>
                            <input type="number" id="bp" onchange="Calc(this);" class="form-control fields" name="buying_price[]" placeholder="Buying price" required>
                        </td>

                        <td>
                            <input type="number" id="sp" onchange="Calc(this);" class="form-control fields" name="selling_price[]" placeholder="Selling price" required>
                        </td>

                        <td>
                            <input type="number" id="bpv" class="form-control fields" name="buying_price_value[]" placeholder="Buying subtotal" readonly required>
                        </td> 

                        <td>
                            <input type="number" id="spv" class="form-control fields" name="selling_price_value[]" placeholder="Selling subtotal" readonly required>
                        </td>

                        <td>
                            <input type="number" id="profit" class="form-control fields" name="profit[]" placeholder="Profit" readonly required>
                        </td>
            ...
            <center>
                <td>
                    <button type="submit" class="btn btn-lg btn-primary mb-3">Add Sales</button>
                </td> 
            </center>
        </form>
    </div>
...
<script>
    ...
    document.getElementById("basic-datepicker").value = today;
</script>